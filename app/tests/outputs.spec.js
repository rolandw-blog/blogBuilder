...
describe("Test getting fullwritepath", () => {
	test("Check if you can get the write dir", () => {
		...
		expect(results[0]).toEqual(
			"/home/roland/Documents/Projects/staticFolio/dist/about/index.html"
		);
		expect(results[1]).toEqual(
			"/home/roland/Documents/Projects/staticFolio/dist/notes/page3/index.html"
		);
		expect(results[2]).toEqual(
			"/home/roland/Documents/Projects/staticFolio/dist/index.html"
		);
	});
});
